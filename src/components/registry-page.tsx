...
const configs: Record<RegistryEntity, {
  ...
  products: {
    ...
    fields: [
      ...
      { key: "ibsCbsCst", label: "CST do IBS/CBS", placeholder: "Ex.: 000" },
      { key: "ibsCbsClassification", label: "Classificação tributária IBS/CBS (cClassTrib)" },
      { key: "ibsStateRate", label: "Alíquota IBS estadual (%)", type: "number", step: "0.0001" },
      { key: "ibsMunicipalRate", label: "Alíquota IBS municipal (%)", type: "number", step: "0.0001" },
      { key: "cbsRate", label: "Alíquota CBS (%)", type: "number", step: "0.0001" },
      { key: "selectiveTaxCst", label: "CST do Imposto Seletivo" },
      { key: "selectiveTaxClassification", label: "Classificação do Imposto Seletivo" },
      { key: "selectiveTaxRate", label: "Alíquota do Imposto Seletivo (%)", type: "number", step: "0.0001" },
      { key: "nbsCode", label: "Código NBS (serviços)" },
      { key: "serviceCode", label: "Código do serviço LC 116 (serviços)" },
