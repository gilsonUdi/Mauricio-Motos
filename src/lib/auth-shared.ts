export const permissionIds = ["atendimento", "compras", "receber", "conferencia", "financeiro", "estoque", "clientes", "veiculos", "produtos", "mecanicos", "fornecedores", "categorias_financeiras", "usuarios"] as const;
