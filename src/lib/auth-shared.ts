export const permissionIds = ["atendimento", "compras", "receber", "pagar", "conferencia", "financeiro", "drg", "estoque", "relatorios", "clientes", "veiculos", "produtos", "mecanicos", "fornecedores", "categorias_financeiras", "configuracoes_financeiras", "usuarios"] as const;
